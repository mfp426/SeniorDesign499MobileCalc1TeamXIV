...
const COMLongitudinalFront=()=>{
    ...
    return(
        <div>
            <h2> Distance behind the Front Axle of COM Location</h2>
            <div className="mb-1 mt-1">
                <label for="axleweightInput" className="form-label"><h2> Weight of rear axle: </h2></label>
...
export default COMLongitudinalFront;